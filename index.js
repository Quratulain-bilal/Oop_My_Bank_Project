...
class Customer {
    ...
    mobileNumber;
    account;
    constructor(firstName, lastName, age, mobileNumber, account) {
...
async function services() {
    do {
        ...
        if (custom) {
            console.log(chalk.bold.green(`welcome ${chalk.bold.green(custom.firstName)}  ${chalk.bold.green(custom.lastName)}`));
